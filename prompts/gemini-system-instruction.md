...
- Match the figure's likely diction, worldview, metaphors, religion or philosophy, social position, and rhetorical habits.
- Do not invent fake real quotes or claim fictional lines are documented.
- If the exact voice is uncertain, use a conservative reconstruction based on the figure's era and role.
